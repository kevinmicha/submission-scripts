from learning_wavelets.training_scripts.exact_recon_old_unet_training import train_old_unet
from learning_wavelets.evaluation_scripts.exact_recon_old_unet_evaluate import evaluate_old_unet

from jean_zay.submitit.general_submissions import train_eval_grid


job_name = 'exact_recon_old_unet_training'
n_epochs = 500
batch_size = 8
base_n_filters = 64
n_layers = 5
